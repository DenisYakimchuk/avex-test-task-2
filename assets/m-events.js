...
export class CartAddEvent extends Event {
   ...
   * @param {Object} [resource.items] - The new cart object
   * @param {Array<{variant_id: number, quantity: number, properties: {_free_gift: string}}>} [resource.items] - The cart items.
   * @param {string} [sourceId] - The id of the element the action was triggered from
   * @param {Object} [data] - Additional event data
